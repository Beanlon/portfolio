...
function GitHubIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4 shrink-0 opacity-80" aria-hidden="true">
      ...
      <div className="site-footer-bar border-t border-slate-200/80 dark:border-white/10">
        <div className="mx-auto max-w-6xl px-5 py-12 md:px-8 md:py-14">
          <div className="grid grid-cols-1 gap-10 sm:grid-cols-3 sm:gap-8">
            <div>
              <h3 className={footerHeadingClasses}>Email</h3>
              <ul className="space-y-3">
                {contactEmails.map(({ address }) => (
                  <li key={address}>
                    <a href={`mailto:${address}`} className={footerLinkClasses}>
                      <EnvelopeIcon />
                      {address}
                    </a>
                  </li>
            ...
            <div>
              <h3 className={footerHeadingClasses}>GitHub</h3>
              <a
                href={github.url}
                target="_blank"
            ...
            <div>
              <h3 className={footerHeadingClasses}>LinkedIn</h3>
              <a
                href={linkedIn.url}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="mt-10 border-t border-slate-200/80 pt-6 text-center text-sm text-slate-500 dark:border-white/10 dark:text-slate-400">
            © {year} Jeric B. Mata. Built with React & Tailwind CSS.
          </div>
        </div>
      </div>
    </footer>
